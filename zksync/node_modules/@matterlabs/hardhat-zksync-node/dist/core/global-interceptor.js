...
async function wrapTaskWithNode(taskArgs, env, runSuper) {
    ...
    const zkSyncGlobal = global;
    const { commandArgs, server, port } = await (0, utils_1.startServer)(env.config.zksyncAnvil.version, env.config.zksyncAnvil.binaryPath, false, { quiet: true, offline: true });
    try {
