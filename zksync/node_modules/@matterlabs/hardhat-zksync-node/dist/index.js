...
(0, config_1.task)(constants_1.TASK_NODE_ZKSYNC, 'Starts a JSON-RPC server for ZKsync node')
    ...
    .addOptionalParam('tag', 'Specified node release for use', undefined)
    .addFlag('force', 'Force download even if the binary already exists')
    .setAction(async ({ port, host, chainId, quiet, log, logFilePath, timestamp, init, state, stateInterval, preserveHistoricalStates, order, noMining, anvilZksyncVersion, anvilZksyncHelp, offline, healthCheckEndpoint, configOut, spawnL1, externalL1, noRequestSizeLimit, autoExecuteL1, blockTime, accounts, balance, autoImpersonate, l1GasPrice, l2GasPrice, l1PubdataPrice, baseTokenSymbol, baseTokenRatio, priceScaleFactor, limitScaleFactor, allowOrigin, noCors, cache, cacheDir, resetCache, verbosity, showNodeConfig, showStorageLogs, showVmDetails, showGasDetails, devSystemContracts, enforceBytecodeCompression, systemContractsPath, protocolVersion, evmInterpreter, emulateEvm, fork, forkBlockNumber, replayTx, tag, force, }, { run }) => {
