...
class VerificationService {
    ...
    async verify(address, contract, constructorArguments, libraries, noCompile, isWithFullContext = false) {
        ...
        const request = {
            ...
            sourceCode: (0, plugin_1.getSolidityStandardJsonInput)(this.hre, await (0, plugin_1.getMinimalResolvedFiles)(this.hre, contractInformation.sourceName), contractInformation.compilerInput, contractInformation.libraries),
