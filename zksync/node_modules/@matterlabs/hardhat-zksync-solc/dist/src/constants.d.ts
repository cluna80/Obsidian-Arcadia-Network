...
export declare const ZKSOLC_BIN_REPOSITORY = "https://github.com/matter-labs/era-compiler-solidity";
...
export declare const TASK_COMPILE_LINK: string;
export declare const ZKSOLC_COMPILER_VERSION_WITH_LIBRARY_LINKING = "1.5.4";
...
export declare const fallbackLatestZkSolcVersion = "1.5.12";
export declare const fallbackLatestEraCompilerVersion = "x.x.x-1.0.1";
export declare const COMPILER_ZKSOLC_LATEST_DEPRECATION = "The 'latest' version specifier is deprecated. Please specify the version of zksolc explicitly.\nTo see available versions and changelogs, visit https://github.com/matter-labs/era-compiler-solidity/releases.";
export declare const COMPILER_ZKSOLC_DEPRECATION_FOR_SOLC_VERSION: (version: string) => string;
