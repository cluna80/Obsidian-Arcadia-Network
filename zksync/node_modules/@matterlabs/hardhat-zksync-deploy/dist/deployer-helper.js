...
exports.createProviders = exports.linkLibrariesIfNeeded = exports._extractFactoryDepsRecursive = exports._extractFactoryDeps = exports.estimateDeployGas = exports.estimateDeployFee = exports.deploy = exports.loadArtifact = void 0;
...
async function deploy(hre, contractNameOrArtifact, constructorArguments = [], zkWallet, deploymentType = 'create', overrides, additionalFactoryDeps) {
    ...
    const artifact = typeof contractNameOrArtifact === 'string'
        ...
        : await loadArtifact(hre, (0, utils_1.generateFQN)(contractNameOrArtifact.sourceName, contractNameOrArtifact.contractName));
    if (linkedBytecode) {
...
async function linkLibrariesIfNeeded(hre, contractNameOrArtifact, libraries) {
    const artifact = typeof contractNameOrArtifact === 'string'
        ? await loadArtifact(hre, contractNameOrArtifact)
        : contractNameOrArtifact;
    return await hre.run(constants_1.TASK_COMPILE_LINK, {
        sourceName: artifact.sourceName,
        contractName: artifact.contractName,
        libraries,
    });
}
exports.linkLibrariesIfNeeded = linkLibrariesIfNeeded;
function createProviders(networks, network) {
    ...
    if (!(0, utils_2.isHttpNetworkConfig)(networkConfig)) {
    ...
    if (SUPPORTED_L1_TESTNETS.includes(ethNetwork)) {
        ethWeb3Provider =
            ethNetwork in networks && (0, utils_2.isHttpNetworkConfig)(networks[ethNetwork])
        ...
        else if ((0, utils_2.isValidEthNetworkURL)(ethNetwork)) {
...
function _createDefaultEthProvider() {
    return new ethers.JsonRpcProvider(constants_2.ETH_DEFAULT_NETWORK_RPC_URL);
}
