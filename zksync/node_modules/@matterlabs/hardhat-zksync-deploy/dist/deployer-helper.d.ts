 ...
 */
export declare function deploy(hre: HardhatRuntimeEnvironment, contractNameOrArtifact: ZkSyncArtifact | string, constructorArguments: any[] | undefined, zkWallet: zk.Wallet, deploymentType?: DeploymentType, overrides?: ZkSyncOverrides, additionalFactoryDeps?: ethers.BytesLike[]): Promise<zk.Contract>;
/**
...
export declare function linkLibrariesIfNeeded(hre: HardhatRuntimeEnvironment, contractNameOrArtifact: ZkSyncArtifact | string, libraries?: {
