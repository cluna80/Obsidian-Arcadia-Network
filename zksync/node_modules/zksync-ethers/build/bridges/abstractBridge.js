...
class AbstractBridge {
    ...
    async getAllowanceL2(token, bridgeAddress, blockTag) {
        const erc20contract = typechain_1.IERC20__factory.connect(token, this.wallet._providerL2());
    ...
    async approveERC20L2(token, bridgeAddress, amount, overrides = {}) {
        const erc20contract = typechain_1.IERC20__factory.connect(token, this.wallet._signerL2());
    ...
    async deposit(transaction) {
        ...
        const tx = {
            ...
            gasPerPubdataByte: transaction.gasPerPubdataByte ||
                utils_1.REQUIRED_L1_TO_L2_GAS_PER_PUBDATA_LIMIT,
        ...
        await (0, adapters_1.insertGasPrice)(this.wallet._providerL1(), tx.overrides);
        ...
        const depositTx = await bridgehub.requestL2TransactionTwoBridges.populateTransaction({
            ...
            refundRecipient: tx.refundRecipient ?? ethers_1.ethers.ZeroAddress,
        ...
        if (!depositTx.gasLimit) {
            ...
            depositTx.gasLimit = (0, utils_1.scaleGasLimit)(baseGasLimit);
        }
