 ...
 * @readonly
 */
export const L2_MESSAGE_VERIFICATION_ABI = new ethers.Interface(L2MessageVerificationABI);
/**
 * The ABI for the `L2InteropRootStorage` interface.
 * @readonly
 */
export const L2_INTEROP_ROOT_STORAGE_ABI = new ethers.Interface(L2InteropRootStorageABI);
/**
