...
export interface L2InteropRootStorageInterface extends Interface {
  getFunction(
    nameOrSignature: "addInteropRoot" | "interopRoots"
  ): FunctionFragment;
...
export namespace InteropRootAddedEvent {
...
export interface L2InteropRootStorage extends BaseContract {
  ...
  interopRoots: TypedContractMethod<
    [chainId: BigNumberish, blockOrBatchNumber: BigNumberish],
    [string],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "addInteropRoot"
  ): TypedContractMethod<
    [
      chainId: BigNumberish,
      blockOrBatchNumber: BigNumberish,
  ...
  getEvent(
    key: "InteropRootAdded"
  ): TypedContractEvent<
    InteropRootAddedEvent.InputTuple,
    InteropRootAddedEvent.OutputTuple,
    InteropRootAddedEvent.OutputObject
  >;

  filters: {
    "InteropRootAdded(uint256,uint256,bytes32[])": TypedContractEvent<
      InteropRootAddedEvent.InputTuple,
      InteropRootAddedEvent.OutputTuple,
      InteropRootAddedEvent.OutputObject
    >;
    InteropRootAdded: TypedContractEvent<
      InteropRootAddedEvent.InputTuple,
      InteropRootAddedEvent.OutputTuple,
      InteropRootAddedEvent.OutputObject
    >;
